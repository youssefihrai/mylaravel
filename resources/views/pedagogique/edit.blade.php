      ...
      <div class="row mt">
        <div class="col-lg-12">
          <div class="form-panel">
            ...
            <form class="form-horizontal style-form"  method="POST"  action="{{ route('Pedagogiqueencadrant.update',['Pedagogiqueencadrant'=>$encadrantcompany->id]) }}" enctype="multipart/form-data">
